  ...
  return (
    <div>
      ...
      <main className="bg-gradient-to-r from-purple-300 to-pink-300 text-blue-500 min-h-screen p-2 space-y-8 relative">
        ...
        {/* Banner */}
        <div className="container flex mx-auto min-h-[75vh] justify-center items-center bg-white shadow-lg rounded-lg p-6">
          <div className="flex flex-col md:flex-row space-y-6 justify-center items-center">
            ...
            <div className="flex-1 grid justify-center items-center " data-aos="flip-left">
              ...
              {/* <ChatArray/> */}
              <img src="/newBannerAni.gif" alt="" className='h-[60vh] w-full '/>
            </div>
          </div>
        </div>
